					...
					// If not
						...
						if ( width < 985 ) {
							...
							var
								...
								m('#menu-1-box > div > div').append( '<div id="menuByClick"><ul>' + menu + '</ul></div>' );
...
===============================================*/
	...
	m('.menu-2 ul li:has(ul)').find('a:first')
					...
					// If not
						...
						if ( width < 985 ) {
							...
							var
								...
								m('#menu-2-box > div > div').append( '<div id="menuByClick"><ul>' + menu + '</ul></div>' );
