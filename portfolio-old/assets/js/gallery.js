...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function setActive(i) {
    ...
    viewportImg.src = src;
    viewportImg.alt = `NC Zoo project image ${index + 1}`;
  ...
  function openModal(i = index) {
    ...
    modalImg.alt = `NC Zoo project image ${index + 1} (expanded)`;
  ...
  function closeModal() {
    ...
    // document.body.style.overflow = ''; // Removed since we don't set it
  }
